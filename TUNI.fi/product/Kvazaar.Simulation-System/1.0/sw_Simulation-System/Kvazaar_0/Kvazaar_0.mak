...
$(ODIR)/camera_supplement.c.o: $(DEPS) ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/supplement/camera_supplement.c
	g++ -MMD -MP -c -o $(ODIR)/camera_supplement.c.o ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/supplement/camera_supplement.c $(INCLUDES) $(DEBUG_FLAGS) $(PROFILE_FLAGS)  -DIP_ACC -I$(SYSTEMC_HOME)/include -lsystemc -std=c++11 -Werror -Wall -Wtype-limits -Wvla -lrt -lm -pthread -O2 -O3  -I$(SYSTEMC_HOME)/include -lsystemc -DSIMULATION_UNTIMED -L. -L$(SYSTEMC_HOME)/lib -std=c++11 -DIP_DEBUG
...
$(ODIR)/encmain_supplement.c.o: $(DEPS) ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/supplement/encmain_supplement.c
	g++ -MMD -MP -c -o $(ODIR)/encmain_supplement.c.o ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/supplement/encmain_supplement.c $(INCLUDES) $(DEBUG_FLAGS) $(PROFILE_FLAGS)  -DIP_ACC -I$(SYSTEMC_HOME)/include -lsystemc -std=c++11 -Werror -Wall -Wtype-limits -Wvla -lrt -lm -pthread -O2 -O3  -I$(SYSTEMC_HOME)/include -lsystemc -DSIMULATION_UNTIMED -L. -L$(SYSTEMC_HOME)/lib -std=c++11 -DIP_DEBUG
...
$(ODIR)/encoderstate_supplement.c.o: $(DEPS) ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/supplement/encoderstate_supplement.c
	g++ -MMD -MP -c -o $(ODIR)/encoderstate_supplement.c.o ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/supplement/encoderstate_supplement.c $(INCLUDES) $(DEBUG_FLAGS) $(PROFILE_FLAGS)  -DIP_ACC -I$(SYSTEMC_HOME)/include -lsystemc -std=c++11 -Werror -Wall -Wtype-limits -Wvla -lrt -lm -pthread -O2 -O3  -I$(SYSTEMC_HOME)/include -lsystemc -DSIMULATION_UNTIMED -L. -L$(SYSTEMC_HOME)/lib -std=c++11 -DIP_DEBUG

$(ODIR)/sc_kvazaar_ip_sub.c.o: $(DEPS) ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/systemc/sc_kvazaar_ip_sub.c
	g++ -MMD -MP -c -o $(ODIR)/sc_kvazaar_ip_sub.c.o ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/systemc/sc_kvazaar_ip_sub.c $(INCLUDES) $(DEBUG_FLAGS) $(PROFILE_FLAGS)  -DIP_ACC -I$(SYSTEMC_HOME)/include -lsystemc -std=c++11 -Werror -Wall -Wtype-limits -Wvla -lrt -lm -pthread -O2 -O3  -I$(SYSTEMC_HOME)/include -lsystemc -DSIMULATION_UNTIMED -L. -L$(SYSTEMC_HOME)/lib -std=c++11 -DIP_DEBUG

$(ODIR)/sc_kvazaar.c.o: $(DEPS) ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/systemc/sc_kvazaar.c
	g++ -MMD -MP -c -o $(ODIR)/sc_kvazaar.c.o ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/systemc/sc_kvazaar.c $(INCLUDES) $(DEBUG_FLAGS) $(PROFILE_FLAGS)  -DIP_ACC -I$(SYSTEMC_HOME)/include -lsystemc -std=c++11 -Werror -Wall -Wtype-limits -Wvla -lrt -lm -pthread -O2 -O3  -I$(SYSTEMC_HOME)/include -lsystemc -DSIMULATION_UNTIMED -L. -L$(SYSTEMC_HOME)/lib -std=c++11 -DIP_DEBUG

$(ODIR)/sc_main.c.o: $(DEPS) ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/systemc/sc_main.c
	g++ -MMD -MP -c -o $(ODIR)/sc_main.c.o ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/systemc/sc_main.c $(INCLUDES) $(DEBUG_FLAGS) $(PROFILE_FLAGS)  -DIP_ACC -I$(SYSTEMC_HOME)/include -lsystemc -std=c++11 -Werror -Wall -Wtype-limits -Wvla -lrt -lm -pthread -O2 -O3  -I$(SYSTEMC_HOME)/include -lsystemc -DSIMULATION_UNTIMED -L. -L$(SYSTEMC_HOME)/lib -std=c++11 -DIP_DEBUG
...
$(ODIR)/search_intra_supplement.c.o: $(DEPS) ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/supplement/search_intra_supplement.c
	g++ -MMD -MP -c -o $(ODIR)/search_intra_supplement.c.o ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/supplement/search_intra_supplement.c $(INCLUDES) $(DEBUG_FLAGS) $(PROFILE_FLAGS)  -DIP_ACC -I$(SYSTEMC_HOME)/include -lsystemc -std=c++11 -Werror -Wall -Wtype-limits -Wvla -lrt -lm -pthread -O2 -O3  -I$(SYSTEMC_HOME)/include -lsystemc -DSIMULATION_UNTIMED -L. -L$(SYSTEMC_HOME)/lib -std=c++11 -DIP_DEBUG

$(ODIR)/search_supplement.c.o: $(DEPS) ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/supplement/search_supplement.c
	g++ -MMD -MP -c -o $(ODIR)/search_supplement.c.o ../../../../../ip.swp.stack/Kvazaar_sim_support/1.0_student/untimed_src/supplement/search_supplement.c $(INCLUDES) $(DEBUG_FLAGS) $(PROFILE_FLAGS)  -DIP_ACC -I$(SYSTEMC_HOME)/include -lsystemc -std=c++11 -Werror -Wall -Wtype-limits -Wvla -lrt -lm -pthread -O2 -O3  -I$(SYSTEMC_HOME)/include -lsystemc -DSIMULATION_UNTIMED -L. -L$(SYSTEMC_HOME)/lib -std=c++11 -DIP_DEBUG
...
//class kvazaar_ip_sub;
//template <int id> void kvazaar_ip_sub::intra_get_angular();
//template <> void kvazaar_ip_sub::intra_get_angular<0>();
...
SC_MODULE (kvazaar_ip_sub)
{
    ...
    // Separate done signal for threads 1-3, first tells when all done
    sc_event intra_get_angular_partial_done[3];
